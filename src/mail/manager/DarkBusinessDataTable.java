 ...
 * @author Studio 7
 */
public class DarkBusinessDataTable extends javax.swing.JFrame {

    /**
     * Creates new form BusinessDataTable
     */
    public DarkBusinessDataTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, 180, 40));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Email From", "Email To", "Subject", "Password"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DarkBusinessDataTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DarkBusinessDataTable().setVisible(true);
            }
        });
    }
